...
CssSelectorCombination.prototype = {
    ...
    combine: function (selector1, combinator, selector2) {
        this.selectors = new Array().concat(('selectors' in selector1) ? selector1.selectors : selector1, ('selectors' in selector2) ? selector2.selectors : selector2);
        this.combinators = new Array().concat(('combinators' in selector1) ? selector1.combinators : [], combinator, ('combinators' in selector2) ? selector2.combinators : []);
        return this;
    },

    stringify: function () {
        var result = new String().concat(this.selectors[0].stringify());
        for (var i = 1; i < this.selectors.length; i++) {
