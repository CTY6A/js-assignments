...
## Javascript Assignments  [![Build Status](https://travis-ci.org/CTY6A/js-assignments.svg?branch=master)](https://travis-ci.org/CTY6A/js-assignments)
...
```
* Open https://github.com/CTY6A/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/CTY6A/js-assignments/builds).
